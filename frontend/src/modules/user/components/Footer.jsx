...
const Footer = () => {
  ...
  return (
    <footer className="border-t bg-background hidden md:block">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-2 group">
              ...
              <span className="text-xl font-logo uppercase tracking-widest font-bold">
                V-Commerce
              </span>
            </Link>
          ...
          {/* Policies */}
          <div>
            <h3 className="font-bold mb-4 text-sm uppercase tracking-wider">Policies</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  to="/privacy"
          ...
          {/* Contact Info */}
          <div>
            <h3 className="font-bold mb-4 text-sm uppercase tracking-wider">Get in Touch</h3>
            <ul className="space-y-3">
        ...
        <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} V-Commerce. All rights reserved.
          </p>
